package com.dff.cloud.Controller;

import com.dff.cloud.Model.Page;
import com.dff.cloud.Model.PageBean;
import com.dff.cloud.Service.FileService;
import com.dff.cloud.Service.UserService;
import com.dff.cloud.Util.CommonUtil;
import com.dff.cloud.Util.MD5Mapper;
...
public class FileController {
    ...
    public String upload(@RequestParam("file") CommonsMultipartFile file, HttpSession Session, HttpServletRequest req, String MD5) {
        ...
        com.dff.cloud.Model.File f = new com.dff.cloud.Model.File();
        //把文件信息存入数据库
    ...
    public String fastUpload(HttpSession session, String MD5) {
        ...
        com.dff.cloud.Model.File source = MD5Mapper.MAP.get(MD5);
    ...
    public String Search(String searchcontent, Page page, Model mv) {
        ...
        List<com.dff.cloud.Model.File> list;
        try {
